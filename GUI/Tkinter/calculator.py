...
button_plus= Button(root, text="+",padx=109,pady=20, command=plus)
button_clear= Button(root, text="Clear",padx=100,pady=20, command=clear)
button_equals= Button(root, text="=",padx=50,pady=20, command=lambda:button_add())

#putting buttons onscreen
